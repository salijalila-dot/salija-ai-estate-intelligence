...
if uploaded_files:
    ...
    if st.button(t["btn"]):
        with st.spinner(t["loading"]):
            ...
            ## SECTION_1
            [Detailed Listing Description - Emotional & Story-driven]
            
            ## SECTION_2
            [Social Media Post - Engaging with emojis & hashtags]
            
            ## SECTION_3
            [Video Script - 30s Reels/TikTok format]
            
            ## SECTION_4
            [Technical Specifications - A clean list of features found in photos like heating, kitchen set, balcony, floor type, etc.]
            """
            try:
